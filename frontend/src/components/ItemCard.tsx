    ...
    <>
      ...
      >
        ...
        <div className="p-4 sm:p-6 flex flex-col flex-grow gap-3">
          ...
          <h3 className="text-lg font-black tracking-tight line-clamp-1 group-hover:text-blue-400 transition-colors uppercase">
            {item.stockName}
          </h3>
          ...
          <div className="mt-auto flex gap-2 pt-2">
            <button 
              ...
              className="flex-1 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white py-3 rounded-2xl font-bold text-[10px] flex items-center justify-center gap-2 hover:bg-slate-100 dark:hover:bg-slate-700 transition-all border border-slate-200 dark:border-slate-700 uppercase tracking-widest"
            >
              <MessageSquare size={14} /> CHAT
            </button>
            <button 
              onClick={(e) => { e.stopPropagation(); addToCart(item); }} 
              className="flex-1 bg-blue-600 text-white py-3 rounded-2xl font-bold text-[10px] flex items-center justify-center gap-2 hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/20 uppercase tracking-widest"
            >
